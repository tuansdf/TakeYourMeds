...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Medicine m1 = new Medicine("Acetaminophen", "Take this product by mouth as directed.", "If you are giving acetaminophen to a child, be sure you use a product that is meant for children. Use your child's weight to find the right dose on the product package. If you don't know your child's weight, you can use their age.", "");
        Medicine m2 = new Medicine("Atenolol", "Take this medication by mouth with or without food as directed by your doctor, usually 1 to 2 times daily.", "Apple juice and orange juice may prevent your body from fully absorbing atenolol. It is best to avoid drinking apple/orange juice within 4 hours of taking atenolol, unless your doctor or pharmacist tells you otherwise.", "");
        Medicine m3 = new Medicine("Contin", "Take this drug with or without food as directed by your doctor, usually every 8 hours or 12 hours. Swallow the tablets whole. Do not break, crush, chew, or dissolve the tablet. Doing so can release all of the drug at once, increasing the risk of morphine overdose.", "Do not increase your dose or use this drug more often or for longer than prescribed, because your risk of side effects may increase.", "");
        Medicine m4 = new Medicine("Atenolol", " You may take this drug with or without food.", "If you are using a liquid form of this medication, use a medication measuring device to carefully measure the prescribed dose. Do not use a household spoon because you may not get the correct dose.", "");
        ...
        Medicine m6 = new Medicine("Hydrocodone-Acetaminophen", "Take this medication by mouth as directed by your doctor. You may take this drug with or without food.", "If you are using a liquid form of this medication, use a medication measuring device to carefully measure the prescribed dose. Do not use a household spoon because you may not get the correct dose.", "");
